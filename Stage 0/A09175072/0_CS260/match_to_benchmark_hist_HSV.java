...
public class match_to_benchmark_hist_HSV implements PlugInFilter {
    ...
    public void run(ImageProcessor ipA) {
        // get benchmark image
        ImagePlus impR = IJ.openImage("E:/AUA/Fall 2019/CS 371 Image Processing/CS260_ImageJ_project/Stage 2/165-11_cropped_HSV.tif");
